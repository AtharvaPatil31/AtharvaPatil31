...
|---------|-------------|------------|
| **[Plantlers - Plant Shopping App](https://github.com/your-username/plantlers)** | A production-grade plant e-commerce app with curated collections by room type and care level. Features Google/Apple auth, wishlist, care reminders, loyalty programme, and a beautifully crafted dark green UI. | Flutter, Firebase, Dart, Figma |
